...
async def chatbotofd(client, message):
    Inflexdb = MongoClient(MONGO_URL)    
    Inflex = Inflexdb["InflexDb"]["Inflex"]     
    ...
    is_Inflex = Inflex.find_one({"chat_id": message.chat.id})
    if not is_Inflex:
        Inflex.insert_one({"chat_id": message.chat.id})
...
async def chatboton(client, message):
    ...
    if is_Inflex:
        Inflex.delete_one({"chat_id": message.chat.id})
...
async def Inflexai(client: Client, message: Message):
...
async def Inflexstickerai(client: Client, message: Message):
...
async def Inflexprivate(client: Client, message: Message):
...
async def Inflexprivatesticker(client: Client, message: Message):
